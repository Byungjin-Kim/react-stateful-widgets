...
export default function Counter() {
  ...
  const increment = () => {
    /* STEP 4 */ //  Do NOT simply do count++. The plus plus is forbidden!
    setCount(count + 1);
  };
  const decrement = () => {
    /* STEP 5 */
    setCount(count - 1); // Do NOT do count--!!!
  };
  const reset = () => {
    /* STEP 6 */
    setCount(0);
  ...
  // For step 2(If count is even, then "royalblue", else "crimson". ), 
  // find how to make function finding "odd" and "even"
